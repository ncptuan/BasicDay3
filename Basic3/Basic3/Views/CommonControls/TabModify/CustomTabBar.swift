...
//            let itemWidth = Double(frame.width / CGFloat(menuItems.count))
//            let offsetX = Double(itemWidth * Double(CGFloat(index)) + itemWidth / 2)
//            print(offsetX);
//
...
//                itemView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: CGFloat(offsetX)),
//                itemView.topAnchor.constraint(equalTo: topAnchor),
//                itemView.widthAnchor.constraint(equalTo: widthAnchor),
//            ])
//        }
//
//        setNeedsLayout()
